...
RefreshTokenGrantType.prototype.handle = function(request, client) {
  ...
  return Promise.bind(this)
    ...
    .then(function(token) {
      return this.saveToken(token.user, client, token.scope,token.PhysicianFacility);
    });
};
...
RefreshTokenGrantType.prototype.saveToken = function(user, client, scope,PhysicianFacility) {
  var fns = [
  ...
  return Promise.all(fns)
    ...
    .then(function(token) {
      token['PhysicianFacility'] = PhysicianFacility;
