...
var grantTypes = {
  ...
  password: require('../grant-types/password-grant-type-otp'),
...
TokenHandler.prototype.getClient = function(request, response) {
  ...
  return promisify(this.model.getClient, 3)(credentials.clientId, credentials.clientSecret,request.body.grant_type)
    .then(function(client) {
      if (!client) {
...
TokenHandler.prototype.handleGrantType = function(request, client) {
  ...
  // if (!_.has(client.grants, grantType)) {
